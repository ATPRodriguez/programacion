...
public class MapperPersonajeTest extends MappersHelp {
    ...
    public void personajeToPersonajeDTOTest() {
        personajeDTOMapper = IPersonajeMapper.INSTANCE.personajeToPersonajeDto(personaje);
    ...
    public void personajeDTOToPersonajeTest() {
        personajeMapper =IPersonajeMapper.INSTANCE.personajeDtoToPersonaje(personajeDTO);
