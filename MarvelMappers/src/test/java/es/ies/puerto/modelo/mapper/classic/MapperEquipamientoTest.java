...
public class MapperEquipamientoTest extends MappersHelp {
    ...
    public void equipamientoToEquipamientoDtoTest () {
        equipamientoDtoMapper = EquipamientoMapper.equipamientoToEquipamientoDTO(equipamiento);
    ...
    public void equipamientoDtoToEquipamientoTest () {
        equipamientoMapper = EquipamientoMapper.equipamientoDtoToEquipamiento(equipamientoDTO);
