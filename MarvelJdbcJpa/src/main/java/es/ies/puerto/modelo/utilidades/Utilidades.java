package es.ies.puerto.modelo.utilidades;
...
public class Utilidades {
    ...
    public final String MESSAGE_ERROR = "No se ha obtenido el resultado esperado";
    ...
    public void dropTablesCreate() throws PersonajeException {
        operacionesBd.actualizar(dropTablesQry);
        operacionesBd.actualizar(scriptBBDD);
    }
}